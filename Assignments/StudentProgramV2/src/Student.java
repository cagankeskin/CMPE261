...
public class Student {
	...
	public static String letterCalc(double average){
		...
		else if (average<=50)lgrade="D";
		else if (average<=60)lgrade="D+";
		else if (average<=65)lgrade="C-";
		else if (average<=70)lgrade="C";
		else if (average<=75)lgrade="C+";
		else if (average<=80)lgrade="B-";
		else if (average<=85)lgrade="B";
		else if (average<=90)lgrade="B+";
		else if (average<=95)lgrade="A-";
		else if (average<=100)lgrade="A";
		return lgrade;
	}
	
	
	
	public Student(String fname, String lname, String id, double q1, double q2, double p, double m, double f, double average,
			String lgrade) {
		super();
		this.fname = fname;
		this.lname = lname;
